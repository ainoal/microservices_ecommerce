...
const server = new GraphQLServer({
    ...
    resolvers,
    context: { orderManagementService: new OrderManagementService}
});

// GraphQL default port is 4000
server.start(() => console.log("Order Management Microservice listening on port 4000"));
